...
def main():
  ...
  nim = tracking.process_im(im_n, props = 'sec',im_bg = skimage.io.imread('toy_data/col_filed.tiff'), thresh_list=[(200, 2000), (0.9, 1)])
  ...
  #print(a,g)
  print(tracking.track('toy_data/ant_scepto-04092018133745-6090*', bg_path='toy_data/col_filed.tiff', thresh_list=[(200, 1200), (0.9, 1)]))
